...
import static io.github.mmuzikar.interactive.cucumber.api.SuggestionItem.withText;
...
import io.cucumber.examples.junit5.calculator.RpnCalculator;
...
public class ShoppingStepDefinitions {
    ...
    @Suggestion(AmountSuggestion.class)
    ...
    public static final class AmountSuggestion implements SuggestionProvider {
        @Override
        public List<SuggestionItem> provide(String step) {
            return Arrays.asList(withText("1.0 USD"), withText("1.0 EUR"), withText("10.0 USD"));
        }
    }
