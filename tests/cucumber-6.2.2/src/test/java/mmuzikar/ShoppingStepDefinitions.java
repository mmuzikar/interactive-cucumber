...
public class ShoppingStepDefinitions {
    ...
    @DataSuggestion(AmountSuggestion.class)
    ...
    public static final class AmountSuggestion implements ISuggestionProvider {
        @Override
        public List<Object> provide(String step) {
            return Arrays.asList("1.0 USD", "1.0 EUR", "10.0 USD");
        }
    }
